  ...
  return (
    ...
    >
      <motion.div
        ...
        -translate-y-1/2 rounded-l-[1.4rem] bg-white p-10 flex flex-col"
      ...
      >
        <div className=" h-full flex flex-col">
          ...
          <div className="flex flex-col h-[70%] overflow-y-auto scrollbar-hide flex-grow">
            {modifiedProductList.length === 0 ? (
              ...
              modifiedProductList.map((item, index) => (
                <div className="flex flex-col">
                  ...
                  <hr className="border-t-gray mt-[1rem]" />
                </div>
              ))
            )}
          </div>
